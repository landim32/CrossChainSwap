...
{
    public class AuctionEquipmentFilterDomainFactory : IAuctionEquipmentFilterDomainFactory
    {
        public IAuctionEquipmentFilterModel BuildAuctionEquipmentFilterModel()
        {
            return new AuctionEquipmentFilterModel();
        }
    }
}
